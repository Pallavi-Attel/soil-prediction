...
def recommend_crop():
    ...
    crop_map = {
        'red soil': 'Groundnut, Cotton, Millets',
        'black soil': 'Cotton, Soybean, Sorghum',
        'clay soil': 'Rice, Wheat, Sugarcane',
        'sandy soil': 'Melons, Peanuts, Potatoes',
        'loamy soil': 'Wheat, Maize, Pulses',
        'alluvial soil': 'Sugarcane, Paddy, Jute'
    }

    crop = crop_map.get(soil_type, 'No recommendation found for this soil type.')
